...
import { Formata } from "../util/Formata";
...
export class Message extends Model {
                            ...
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_3a5-b">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time">${Formata.timeStampToTime(this.timeStamp)}</span></div>
                                </div>
                            </div>
                            <div class="_6qEXM">
            ...
            case 'audio':
                ...
                <div class="_3_7SH _17oKL">
                    <div class="_2N_Df LKbsn">
                        ...
                        <div class="_27K_5">
                            <div class="_1DZAH" role="button">
                                <span class="message-time">${Formata.timeStampToTime(this.timeStamp)}</span>
                            </div>
                        </div>
                    </div>
                ...
                audioEl.onpause = e => {
                    audioDuration.innerHTML = Formata.toTime(this.duration * 1000);
                    btnPlay.show();
                    btnPause.hide();
                };
                ...
                audioEl.ontimeupdate = e => {
                    ...
                    btnPlay.hide();
                    btnPause.hide();
                    audioDuration.innerHTML = Formata.toTime(audioEl.currentTime * 1000);
    ...
    static sendAudio(chatId, from, file, metadata, photo) {
        ...
        return Message.send(chatId, from, 'audio', '').then(msgRed => {
