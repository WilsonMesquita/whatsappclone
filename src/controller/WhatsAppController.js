...
export class WhatsAppController {
            ...
            this.el.alertNotificationPermission.on('click', e => {
                ...
                Notification.requestPermission(permission => {
                    ...
                    if (permission === 'granted') {
                        ...
                        Console.info('notificaçõs Permitidas!');
                    }
                });
    ...
    notification(data) {
        ...
        if (Notification.permission === 'granted' && !this.active) {
            ...
            let soud = new Audio('./audio/alert.mp3');
            soud.currentTime= 0;
            soud.play();
                    ...
                    div.innerHTML = `
                        ...
                        <div class="_3j7s9">
                            <div class="_2FBdJ">
                                ...
                                <div class="_3Bxar">
                                    <span class="_3T2VG"${Formata.timeStampToTime(contact.lastMessageTime)}></span>
                                </div>
                            </div>
                            <div class="_1AwDx">
                                <div class="_itDl">
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
                ...
                docs.forEach(doc => {
                    ...
                    if (message.type === 'contact') {
                        ...
                        view.querySelector('.btn-message-send').on('clikck', e => {
    ...
    loadElements() {
        ...
        document.querySelectorAll('[id]').forEach(element => {
            ...
            this.el[Formata.getCameCase(element.id)] = element;
    ...
    initEvents() {
        ...
        this.el.btnSendMicrophone.on('click', e => {
            ...
            this.el.btnCancelMicrophone.on('recordtimer', timer => {
